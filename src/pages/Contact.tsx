  ...
  <div className="container mx-auto px-5 relative z-10">
        ...
        <div className="relative mb-36">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            {/* Croatian Version */}
            <Card2 variant="glass-primary"className="bg-surface-dark/80 backdrop-blur-sm border-primary hover:border-primary/100 transition-all duration-500 hover-lift overflow-hidden glow-on-hover animate-slide-up">
              <Card2Header>
                <Badge className="w-fit mb-2 bg-primary/20 text-primary">Hrvatski</Badge>
                <Card2Title className="text-3xl text-foreground">O Meni</Card2Title>
              </Card2Header>
            ...
            <Card2 variant="glass-primary"className="bg-surface-dark/80  backdrop-blur-sm border-primary hover:border-primary/100 transition-all duration-500 hover-lift overflow-hidden glow-on-hover animate-slide-up">
              <Card2Header>
                ...
                <Card2Title className="text-3xl text-foreground">About Me</Card2Title>
              </Card2Header>
              <Card2Content className="relative">
       ...
       <div className="mb-12">
         ...
         <div className="flex justify-center">
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-24">
             ...
             <Card2 variant="glass-primary" className="bg-surface-dark/80 backdrop-blur-sm border-primary hover:border-primary/50 transition-all duration-500 hover:scale-105 group hover-lift glow-on-hover animate-slide-up">
               <Card2Content className="p-6">
                 <div className="flex items-center justify-between mb-4">
                   <Users className="h-8 w-8 text-primary group-hover:scale-110 transition-transform" />
                   <TrendingUp className="h-5 w-5 text-green-500" />
                 </div>
                 <h3 className="text-3xl font-bold text-foreground mb-2">
                   <span className="animate-count" data-target="4.62">0</span> K
                 </h3>
             ...
             <Card2 variant="glass-primary" className="bg-surface-dark/80 backdrop-blur-sm border-primary hover:border-primary/50 transition-all duration-500 hover:scale-105 group hover-lift glow-on-hover animate-slide-up">
               <Card2Content className="p-6">
                 ...
                 <h3 className="text-3xl font-bold text-foreground mb-2">
                   <span className="animate-count" data-target="1.46">0</span> K
                 </h3>
        ...
        <div className="mb-24">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 mx-auto gap-6 animate-slide-up">
            {[
              ...
              variant="default"
              key={index} 
                className="bg-surface-dark/60 backdrop-blur-sm border-primary hover:border-primary/70 transition-all duration-500 hover:scale-105 group overflow-hidden hover-lift glow-on-hover"
              >
                ...
                {/* Tekst ispod slike */}
                <Card2Content className="p-4">
                  <div className="text-lg md:text-xl lg:text-2xl font-bold text-center text-foreground/90 group-hover:text-primary transition-colors">
                    {sponsor.name}
                  </div>
...
<div className="pb-32 pt-12">
  ...
  <div className="max-w-4xl mx-auto">
    <Card2 variant="default" className="bg-surface-dark/80 backdrop-blur-sm border-primary">
      <Card2Content className="p-8">
